...
|------------|----------------|------------------------------------------------|---------------------------------------------|
| Sept 7th   | [Week 1](./Week%201)         | [Kickoff Meeting and Cloud Computing Intro](./Week%201)      | - Introduction to the club and members<br>- What is Cloud Computing? Introduction to AWS services<br>- Overview of the semester's project<br>- AWS & GitHub account registration/setup |
